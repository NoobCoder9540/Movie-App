                ...
                <div className='row'>
                        ...
                        <ul class="list-group genre-selector">

                            {
                                this.state.genres.map((genre) => (
                                    this.state.currgenre == genre ? <li style={{ background : '#3f51b5' , color :'white',fontWeight : 'bold'}} class="list-group-item" >{genre}</li> : <li style={{color : '#3f51b5'}} class="list-group-item" onClick={()=> this.handleGenreChange(genre)}>{genre}</li>
                    ...
                    <div className='col-9 favourites-table'>
                        <div className='row'>
                            ...
                            <input placeholder='Search' type='text'  className='input-group-text col' value={this.state.currText} onChange={(e)=> this.setState({currText:e.target.value})}></input>
                                ...
                                <tbody>
                                    {
                                        filterArr.map((movieElem) => (
                                            <tr>
                                                <td><img style={{ width: '6rem' }} src={`https://image.tmdb.org/t/p/original${movieElem.backdrop_path}`}></img></td>
